...
func (r *runtime) RegisterPackage(pkg *ast.Package) error {
	...
	if r.pkgs == nil {
		r.pkgs = make(map[string]*ast.Package)
	}
...
func (r *runtime) Eval(ctx context.Context, astPkg *ast.Package) ([]interpreter.SideEffect, values.Scope, error) {
...
func (r *runtime) evalHandle(ctx context.Context, h *libflux.ASTPkg) ([]interpreter.SideEffect, values.Scope, error) {
